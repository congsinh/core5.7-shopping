...
(function($) {
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2018/12/5', function(event) {
            var $this = $(this).html(event.strftime('' +
                '<div class="box"><div class="date">%D</div> <span>Ngày</span> </div>' +
                '<div class="box"><div class="date">%H</div> <span>Giờ</span> </div>' +
                '<div class="box"><div class="date">%M</div> <span>Phút</span> </div>' +
                '<div class="box"><div class="date">%S</div> <span>Giây</span> </div>'));
        });
    }
